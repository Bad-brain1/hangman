...
namespace badbrain\hangman\Controller;

use function badbrain\hangman\Model\addAttemptsInfo;
use function badbrain\hangman\View\showGame;
use function badbrain\hangman\Model\openDB;
use function badbrain\hangman\Model\createRecord;
use function badbrain\hangman\Model\gameList;
use function badbrain\hangman\Model\gameReplay;
use function badbrain\hangman\Model\updateDB;
...
function startGame()
{
    ...
    if ($rightAnswers == $lengthWord) {$result = "Win";} else {$result = "Lose";}
